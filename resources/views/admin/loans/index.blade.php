    ...
    <div class="py-10 bg-slate-100 dark:bg-slate-900 min-h-screen">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-6">
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-3xl font-bold tracking-tight text-amber-600 dark:text-amber-400">
                                {{ number_format($loans->where('status', 'dipinjam')->count()) }}</p>
                        </div>
                        <div
            ...
            <div
                ...
                <div
                    class="border-b border-slate-100 px-6 py-5 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 space-y-4">
                    ...
                    <form action="{{ url()->current() }}" method="GET"
                        ...
                        <div class="w-full sm:w-48">
                            <select name="status" onchange="this.form.submit()"
                                ...
                                <option value="dikembalikan"
                                    {{ request('status') === 'dikembalikan' ? 'selected' : '' }}>Kembali</option>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <button type="button" id="exportExcelBtn"
                                class="inline-flex items-center gap-1.5 rounded-xl border border-emerald-200 bg-emerald-50 px-3.5 py-2 text-xs font-semibold text-emerald-700 shadow-sm transition hover:bg-emerald-100 dark:border-emerald-800 dark:bg-emerald-900/40 dark:text-emerald-400">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <button type="button" id="exportPdfBtn" onclick="pdfButton()"
                                class="inline-flex items-center gap-1.5 rounded-xl border border-rose-200 bg-rose-50 px-3.5 py-2 text-xs font-semibold text-rose-700 shadow-sm transition hover:bg-rose-100 dark:border-rose-800 dark:bg-rose-900/40 dark:text-rose-400">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <tr>
                                    <td colspan="7" class="px-6 py-16 text-center">
                                        <div class="flex flex-col items-center justify-center gap-2">
                                            ...
                                            <p class="text-sm font-semibold text-slate-700 dark:text-slate-300">Data
                                                tidak ditemukan atau belum ada data peminjaman</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
