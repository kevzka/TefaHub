    ...
    <div class="py-10 bg-slate-100 dark:bg-slate-900 min-h-screen">
        <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="overflow-hidden rounded-3xl bg-white shadow-sm ring-1 ring-slate-200 dark:bg-slate-800 dark:ring-slate-700">
                ...
                <form action="{{ route('admin.items.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6 p-6 sm:p-8">
                    @csrf
                    ...
                    <div class="grid gap-6 md:grid-cols-2">
                        ...
                        <label class="block md:col-span-2">
                            ...
                            <p class="mt-2 text-xs text-slate-500 dark:text-slate-400">Opsional, format JPG/PNG/WEBP.</p>
                        </label>
                    </div>
