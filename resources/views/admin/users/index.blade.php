                ...
                <div
                    ...
                    <div class="mt-6 flex flex-wrap gap-3 font-sans">
                        <a href="{{ route('admin.users.create') }}"
                            class="inline-flex items-center justify-center gap-2 rounded-xl bg-indigo-600 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-indigo-600/30 transition hover:bg-indigo-500 active:scale-95">
                ...
                <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-3xl font-bold tracking-tight text-indigo-600 dark:text-indigo-400">Users
                            </p>
                        </div>
                        <div
                            class="rounded-2xl bg-indigo-50 p-3 text-indigo-600 dark:bg-indigo-900/50 dark:text-indigo-400">
                            <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M5 13l4 4L19 7" />
                            </svg>
