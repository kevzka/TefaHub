        ...
        <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 space-y-6">
            <div class="grid gap-6 lg:grid-cols-[1.6fr_0.9fr]">
                <div class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-900 p-8 text-white shadow-xl ring-1 ring-white/10 flex flex-col justify-between dark:from-slate-800 dark:via-slate-800 dark:to-slate-900">
                    ...
                    <div class="relative">
                        ...
                        <h1 class="mt-1 text-3xl font-extrabold tracking-tight sm:text-4xl">Tambah User</h1>
                ...
                <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
                    <div class="flex items-center justify-between rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-slate-800 dark:ring-slate-700">
                        <div>
                            ...
                            <p class="mt-2 text-3xl font-bold tracking-tight text-slate-900 dark:text-white">User</p>
                        </div>
            ...
            <div class="overflow-hidden rounded-3xl bg-white shadow-sm ring-1 ring-slate-200 dark:bg-slate-800 dark:ring-slate-700">
                <div class="border-b border-slate-100 bg-slate-50 px-6 py-5 dark:border-slate-700 dark:bg-slate-900">
                    <h3 class="text-lg font-bold text-slate-900 dark:text-white">Form User Baru</h3>
                    <p class="mt-0.5 text-xs text-slate-500 dark:text-slate-400">Masukkan nama, kelas, dan email user yang akan ditambahkan.</p>
                </div>
                ...
                <form action="{{ route('admin.users.store') }}" method="POST" class="space-y-6 p-6 sm:p-8">
                    ...
                    <div class="grid gap-6 md:grid-cols-2">
                        <label class="block">
                            ...
                            <input type="text" name="name" placeholder="Please enter name user" class="w-full rounded-xl border-slate-300 bg-white px-4 py-3 text-sm shadow-sm focus:border-slate-900 focus:ring-slate-900 dark:border-slate-600 dark:bg-slate-900 dark:text-white">
                        </label>

                        <label class="block">
                            <span class="mb-2 block text-sm font-medium text-slate-700 dark:text-slate-200">Class</span>
                            <input type="text" name="class" placeholder="Please enter class user" class="w-full rounded-xl border-slate-300 bg-white px-4 py-3 text-sm shadow-sm focus:border-slate-900 focus:ring-slate-900 dark:border-slate-600 dark:bg-slate-900 dark:text-white">
                        </label>
