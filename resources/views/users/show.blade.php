        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-6">
            <div class="grid gap-6 lg:grid-cols-[1.6fr_0.9fr]">
                <div class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-900 p-8 text-white shadow-xl ring-1 ring-white/10 flex flex-col justify-between dark:from-slate-800 dark:via-slate-800 dark:to-slate-900">
                    ...
                    <div class="relative">
                        ...
                        <h1 class="mt-1 text-3xl font-extrabold tracking-tight sm:text-4xl">Detail User</h1>
                        <p class="mt-2 max-w-xl text-sm leading-relaxed text-slate-300">
                            Ringkasan informasi pengguna yang terdaftar di sistem.
                        </p>
                    </div>
                    ...
                    <div class="mt-6 flex flex-wrap gap-3 font-sans">
                        ...
                        <a href="{{ route('admin.users.edit', $user->id) }}" class="inline-flex items-center justify-center gap-2 rounded-xl bg-indigo-600 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-indigo-600/30 transition hover:bg-indigo-500 active:scale-95">
                ...
                <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
                    <div class="flex items-center justify-between rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-slate-800 dark:ring-slate-700">
                        <div>
                            <p class="text-sm font-medium text-slate-500 dark:text-slate-400">User ID</p>
            ...
            <div class="overflow-hidden rounded-3xl bg-white shadow-sm ring-1 ring-slate-200 dark:bg-slate-800 dark:ring-slate-700">
                <div class="border-b border-slate-100 bg-slate-50 px-6 py-5 dark:border-slate-700 dark:bg-slate-900">
                    <h3 class="text-lg font-bold text-slate-900 dark:text-white">Rincian User</h3>
                    <p class="mt-0.5 text-xs text-slate-500 dark:text-slate-400">Informasi lengkap user ditampilkan dalam panel yang konsisten.</p>
                </div>
                ...
                <div class="grid gap-6 p-6 sm:p-8 md:grid-cols-2">
                    <div class="rounded-2xl bg-slate-50 p-5 dark:bg-slate-900/50">
                        ...
                        <p class="mt-1 text-lg font-semibold text-slate-900 dark:text-white">{{ $user->name }}</p>
                    </div>
                    <div class="rounded-2xl bg-slate-50 p-5 dark:bg-slate-900/50">
                        <p class="text-sm text-slate-500 dark:text-slate-400">Class</p>
                        <p class="mt-1 text-lg font-semibold text-slate-900 dark:text-white">{{ $user->class }}</p>
                    </div>
                    <div class="rounded-2xl bg-slate-50 p-5 md:col-span-2 dark:bg-slate-900/50">
                        ...
                        <p class="mt-1 text-lg font-semibold text-slate-900 dark:text-white">{{ $user->email }}</p>
                    </div>
                </div>
            </div>
        </div>
